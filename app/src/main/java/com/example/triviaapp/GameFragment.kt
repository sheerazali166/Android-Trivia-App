...
class GameFragment : Fragment() {
    ...
    // TODO: The first answer is correct one. we randomize the answers before shwing the text.
    // TODO: All questions must have four answers. we'd want these to contain references to string
    // TODO: resources so we could internationalize. (or better yet, not define the questions in code...)
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        // TODO: Shuffles the questions and sets the question index to first question
        randomizeQuestions()

        // TODO: Bind this fragment class to the layout
        binding.game = this

        // TODO: Set the onclick listener for the submit button
        binding.submitButton.setOnClickListener { view: View ->

            val checkedId = binding.questionRadioGroup.checkedRadioButtonId

            // TODO: Do nothing if nothing is checked (id == -1)
            ...
            if (checkedId != -1) {
                ...
                // TODO: The first answer in the original question is always the correct one, so if our
                // TODO: answer matches, we have the correct answer.
                if (answers[answerIndex] == currentQuestion.answers[0]) {
                    questionIndex++

                    // TODO: Advance to the next question
                    if (questionIndex < numQuestions) {
                        ...
                        // TODO: We've won! Navigate to the gameWonFragment
                    ...
                    // TODO: Game over! A wrong answer sends us to the gameOverFragment
    ...
    // TODO: Randomize the questions and set the first question
    ...
    // TODO: Sets the question and randomizes the answers. this only changes the data, not the UI.
    // TODO: Calling invalideAll on the FramentGameBinding updates the data.
    private fun setQuestion() {
        currentQuestion = questions[questionIndex]

        // TODO: Randomize the answers into a copy of the array
        answers = currentQuestion.answers.toMutableList()

        // TODO: and shuffle them
        answers.shuffle()
        (activity as AppCompatActivity)
            .supportActionBar?.title = getString(R.string.title_android_trivia_question, questionIndex + 1, numQuestions)
    }
}